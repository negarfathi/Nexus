...
l1_invariant = (l1_v2 >= IntVal(-1))
l1_invariant_next = (l1_v2_next >= IntVal(-1))

l1_ranking_function = [If((l1_v2 > IntVal(0)), l1_v2, IntVal(0))]
l1_ranking_function_next = [If((l1_v2_next > IntVal(0)), l1_v2_next, IntVal(0))]
