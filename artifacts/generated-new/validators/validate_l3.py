...
# Exit steps
l2_exit_steps_p1 = And(And((l2_v6 >= IntVal(0)), (l2_v6 != IntVal(10)), (l2_v6 != IntVal(8)), (l2_v6 == IntVal(6))), (l2_v1_out == l2_v1), (l2_v2_out == l2_v2), (l2_v3_out == l2_v3), (l2_v4_out == l2_v4), (l2_v5_out == l2_v5), (l2_v6_out == l2_v6), (l2_v7_out == l2_v7))
...
l2_return_steps_p3 = (l2_v6 < IntVal(0))
fp.rule(l2_return_steps(l2_v1, l2_v2, l2_v3, l2_v4, l2_v5, l2_v6, l2_v7), l2_return_steps_p3, name="l2_return_steps_p3")
...
l3_recurrent_set = And(And((l3_v7 > IntVal(0)), (l3_v5 == IntVal(0))), (l3_v7 == IntVal(2)))
l3_recurrent_set_next = And(And((l3_v7_next > IntVal(0)), (l3_v5_next == IntVal(0))), (l3_v7_next == IntVal(2)))
